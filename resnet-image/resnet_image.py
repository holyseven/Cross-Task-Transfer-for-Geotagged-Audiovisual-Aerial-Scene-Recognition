...
'''
 Modified the 'AvgPool' to 'AdaptiveAvgPool 
'''
...
class ResNet(nn.Layer):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.avgpool = nn.AdaptiveAvgPool2d((1,1)) #nn.AvgPool2d(7, stride=1)         self.avgpool = nn.AdaptiveAvgPool2d((1,1)) #nn.AvgPool2d(7, stride=1)
...
def resnet18(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.set_dict(paddle.load(model_urls['resnet18']))
    return model
...
def resnet34(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.set_dict(paddle.load(model_urls['resnet34']))
    return model
...
def resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.set_dict(paddle.load(model_urls['resnet50']))
    return model
...
def resnet101(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.set_dict(paddle.load(model_urls['resnet101']))
    return model
...
def resnet152(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.set_dict(paddle.load(model_urls['resnet152']))
    return model
